...
from tensorflow.keras.preprocessing.image import dataset_from_directory
...
ds = dataset_from_directory("/projects/cmda_capstone_project_ti/data/training_sets/NativeChips")
