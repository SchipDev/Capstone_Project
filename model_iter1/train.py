...
#ds = dataset_from_directory("/projects/cmda_capstone_project_ti/data/training_sets/NativeChips", image_size=(400,400))
#print(ds)
# Construct model
model = unet()
...
print(model.fit(native_chips, _05masks, epochs=25))
