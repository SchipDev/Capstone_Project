...
READ_PATH = "../data/data_summary_final_summary.csv"   # Path of csv file to read from
WRITE_PATH = "../data/training_sets/"    # Path of directory where output training csv file is to be saved
